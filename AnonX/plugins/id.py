...
PM_START_TEXT = """**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝙌 - 🧑🏻‍💻🖤 گەشەپێدەران](t.me/MGIMT)**\n••┉┉┉┉┉••🝢••┉┉┉┉┉••\n**
**بەخێربێی ئەزیزم* {} , 🥀**
**๏ من {} بۆتی پاراستنی گرووپم**
**دەتوانیت بەکارمبهێنیت بە ‌باشترین شێواز پەرەپێدراوم!**
**➻ باشترین پارێزەری گرووپ  ➕ لەگەڵ فەرمانی پەخشکردنی گۆرانی وەك بۆتی گۆرانی**
─────────────────
   *➻ بەکارهێنەر »* {}
   *➻ گرووپ »* {}
─────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="فەرمانەکان و یارمەتی", callback_data="Main_help"),
    ],
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                    [
                                        ...
                                        [
                                            ...
                                            InlineKeyboardButton(
                                                text="ᴜᴩᴅᴀᴛᴇs 🍷",
                                                url=f"\x68\x74\x74\x70\x73\x3A\x2F\x2F\x74\x2E\x6D\x65\x2F\x6D\x75\x6B\x65\x73\x68\x62\x6F\x74\x7A\x6F\x6E\x65"
                                            ),
                                        ],
                                        [
                                            InlineKeyboardButton(
                                            ...
                                            InlineKeyboardButton(
                                                text="ɢɪᴛʜᴜʙ 🍹",
                                                url="\x68\x74\x74\x70\x73\x3A\x2F\x2F\x67\x69\x74\x68\x75\x62\x2E\x63\x6F\x6D\x2F\x6E\x6F\x6F\x62\x2D\x6D\x75\x6B\x65\x73\x68"
                                            ),
                                        ],
                                        [
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""", parse_mode=ParseMode.MARKDOWN,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                    [[
                                        ...
                                        [
                                            InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/mukeshbotzone/7"),
                                            InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                                        ]
                                    ]
                                ),
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                    InlineKeyboardButton(text="sᴏᴜʀᴄᴇ",
...
def donate(update: Update, context: CallbackContext, DONATION_LINK=None):
