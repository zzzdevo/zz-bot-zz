...
@app.on_message(filters.regex(r'تەمەنم'))###كتابة الوسكي من الصفر
async def calculate_age(client:Client, message:Message):
    try:
        ...
        await message.reply_text(f"•⎆┊ئەزیزم {message.from_user.mention} ببورە تۆ فەرمانی هەڵەت نوسیووە، ئاوا بینووسە (تەمەنم1-1-2000) **")
        return
